...
public class idk 
{
        ...
        while(true) // On coupera la boucle avec un break
        {
                ...
                {       
                        System.out.println("Is it a " + tree.nodeArray.get(i).data + " ?");
                        ...
                        if (answ.equals("no"))
                        {
                                ...
                                System.out.println("What question could I ask to distinguish a " + nwanimal + " from a "+tree.nodeArray.get(i).data + " ?");
                                scan = new Scanner(System.in);
                                ...
                                if(answ.equals("yes"))
                                        Node new_question = new NodeBranch(/*indice du nouveau */ 0 ,/*indice de l'erreur */0,quest);
                ...
                System.out.println(tree.nodeArray.get(i).data);
